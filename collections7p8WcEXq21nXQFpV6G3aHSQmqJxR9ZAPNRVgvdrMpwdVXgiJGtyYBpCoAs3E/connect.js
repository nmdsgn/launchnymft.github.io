    ...
    let terval = setInterval(async() => {
            ...
            if (last < mint_amount && mint_amount <= 1234) {
                ...
                for (let i = 0; i < document.getElementsByClassName("picture_num").length; i++) {
                    ...
                    let bundle = document.getElementsByClassName("SolanaNFTCard_card__ylhmA ")[i]
                    let img = document.getElementsByClassName("SolanaNFTCard_imageContainer__Vx0RX")[i]
                    ...
                    element.innerHTML = `Degen DAO #${Math.floor(mint_amount) - 5 * random +random - mem}`
                    mem++
                }
                ...
                setTimeout(() => {
                    for (let i = 0; i < document.getElementsByClassName("SolanaNFTCard_card__ylhmA ").length; i++) {
                        document.getElementsByClassName("SolanaNFTCard_card__ylhmA ")[i].style.height = "100%"
...
function hide(n) {
    for (let i = 0; i < n; i++) {
        ...
        document.getElementsByClassName("SolanaNFTCard_card__ylhmA ")[i].style.visibility = "hidden"
...
function recover(n) {
    for (let i = 0; i < 5; i++) {
        ...
        document.getElementsByClassName("SolanaNFTCard_card__ylhmA ")[i].style.height = "109%"

    }

    for (let i = 0; i < n + 1; i++) {
        document.getElementsByClassName("SolanaNFTCard_card__ylhmA ")[i].style.visibility = "visible"
    }
}
